...
// let's please keep all important aspects of the application separate.
// the file down below will determine the environment of the application.
...
require __DIR__ . '/bootstrap/acl.php';
